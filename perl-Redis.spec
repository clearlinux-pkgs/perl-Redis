...
%prep
%setup -q -n Redis-1.996
cd %{_builddir}/Redis-1.996
...
cp %{_builddir}/Redis-1.996/LICENSE %{buildroot}/usr/share/package-licenses/perl-Redis/b8c4d541f43eb6518a9f41d1a6b1e73edab724dd
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/Redis.pm
/usr/lib/perl5/vendor_perl/5.30.3/Redis/Hash.pm
/usr/lib/perl5/vendor_perl/5.30.3/Redis/List.pm
/usr/lib/perl5/vendor_perl/5.30.3/Redis/Sentinel.pm
