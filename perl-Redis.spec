...
Version  : 1.999
Release  : 18
URL      : https://cpan.metacpan.org/authors/id/D/DA/DAMS/Redis-1.999.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAMS/Redis-1.999.tar.gz
...
%prep
%setup -q -n Redis-1.999
cd %{_builddir}/Redis-1.999
...
cp %{_builddir}/Redis-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Redis/b8c4d541f43eb6518a9f41d1a6b1e73edab724dd
if test -f Makefile.PL; then
